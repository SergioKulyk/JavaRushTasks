...
public class Solution {
    ...
    public static class Garden {
        ...
        public synchronized void addFruit(int index, String fruit) { synchronized(this) {fruits.add(index, fruit);} }
        public synchronized void removeFruit(int index) {
            if (index < fruits.size())
                synchronized(this) { fruits.remove(index); }
        }

        public synchronized void addVegetable(int index, String vegetable) { synchronized(this) { vegetables.add(index, vegetable); } }
